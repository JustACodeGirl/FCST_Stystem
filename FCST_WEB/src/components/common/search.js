...
class Search extends React.Component {
  ...
  //       break;
  //     case 1:
  //       onEditItem(selectedRowKeys[0]);
  //       break;
  //     default:
  //
  //       message.warn('只能同时编辑一条记录', 2);
  //       break;
  //   }
  // };
      ...
      <Row gutter={24}>
        ...
        <Col lg={{ offset: 6, span: 10 }} md={14} sm={14} xs={24} style={{ marginBottom: 16, textAlign: 'right' }}>
          <Input.Group compact size="large" className={styles.search}>
            <Input ref="searchInput" size="large" style={{width: '40%'}} onChange={this.handleInputChange} onPressEnter={this.handleSearch} />
