...
const schedules = require('../../mock/schedule');
const schemes = require('../../mock/scheme');
const adminRoles = require('../../mock/adminRole');
const mockData = [patients, app, schedules, schemes, adminRoles];
